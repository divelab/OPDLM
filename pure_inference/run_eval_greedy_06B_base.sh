...
# ══════════════════════════════════════════════════════════════════════
MODELS=(
    "experiments/s128b4bs8_ForKL_Tea06B_Stu06B_len4ks100_lr1e-5cos_onestate_thres97s150_0422_015334/ckpt/epoch-480"
    # "pretrained_models/BD3LM/Qwen3-0.6B-diffusion-bd3lm-v0.1"
)
MODEL_BASES=(
    "bd3lm"
    # "bd3lm"
...
TAG="greedy_OPDLM_0.6B_base"                 # subdir suffix: "greedy" or "sample"
