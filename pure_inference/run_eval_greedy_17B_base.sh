...
# ══════════════════════════════════════════════════════════════════════
MODELS=(
    "experiments/s128b4bs8_ForKL_Tea17B_Stu17B_len4ks100_lr1e-5cos_onestate_thres97s150_0421_223445/ckpt/epoch-480"
)
MODEL_BASES=(
    "bd3lm"
)
...
TAG="greedy_OPDLM_1.7B_base"                 # subdir suffix: "greedy" or "sample"
