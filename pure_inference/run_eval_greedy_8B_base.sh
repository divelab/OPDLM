...
# ══════════════════════════════════════════════════════════════════════
MODELS=(
    "experiments/s128b4bs8_ForKL_Tea8B_Stu8B_len4ks100_lr1e-5cos_onestate_thres97s150_0423_010850/ckpt/epoch-480"
)
MODEL_BASES=(
    "bd3lm"
)
...
TAG="greedy_OPDLM_8B_base"                 # subdir suffix: "greedy" or "sample"
