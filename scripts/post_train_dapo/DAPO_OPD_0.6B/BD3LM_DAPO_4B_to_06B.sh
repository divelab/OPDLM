...
#SBATCH --nodes=1
#SBATCH --gres=gpu:2             # Default. Override at submit time for multi-GPU runs.
...
STUDENT=$DATA_PATH/pretrained_models/BD3LM/Qwen3-0.6B-a2d-init
...
RUN_NAME=s128b4bs2_ForKL_Tea4B_StuARM_len014ks100cos_inf
